...
/** TYPES */
import type { ProductVariantGroup } from "@/lib/shopify";
...
export function Colors({
  ...
  const handleColorChange = (variant: ProductVariantGroup) => {
    router.replace(`?variant=${encodeURIComponent(variant.color)}`);
